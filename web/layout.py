...
def _sidebar(active: str = "") -> Div:
    ...
    `active` deve ser uma das chaves: dashboard, proxy, config,
...
def _page_shell(title: str, active: str, *content) -> Any:
    ...
    Substitui Titled() para páginas com sidebar.
    """
    return Html(
        Head(
            Meta(charset="utf-8"),
