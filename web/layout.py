...
#sidebar .nav-item:hover { color: #e6edf3; background: #21262d; }
...
#sidebar .nav-sub:hover { color: #e6edf3; background: #21262d; }
...
form label { display: block; margin-bottom: 14px; font-size: 0.88rem; color: #8b949e; }
...
form input[type=checkbox] { margin-right: 6px; width: auto; display: inline; }
button, .btn {
...
.badge-active   { background: #1a3a1a; color: #3fb950; border: 1px solid #238636; padding: 2px 10px; }
.badge-frozen   { background: #1c2a3a; color: #58a6ff; border: 1px solid #1f6feb; padding: 2px 10px; }
...
.tag .remove-tag {
    cursor: pointer; color: #8b949e; font-size: 0.9rem;
...
def _page_shell(title: str, active: str, *content) -> Any:
    return Html(
        ...
        Body(
            _sidebar(active),
            Div(H1(title), *content, id="main-content"),
        ),
    )
