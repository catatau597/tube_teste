...
Referência: REFACTORING_TUBEWRANGLERR.md v3.2
...
```markdown
# Copilot Instructions — TubeWranglerr v3.2
...
*Versão 3.2 — Incorpora lições da Etapa 3: catch-all de extensões, @app.get vs @rt, Pylance como falso positivo, web/main.py canônico completo.*
